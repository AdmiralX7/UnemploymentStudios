...
function create() {
    ...
    // Create the ground
// Create a repeating ground strip
this.add.tileSprite(400, 568, 800, 64, 'ground_tile')
.setScale(0.083)        // 64  / 768 ≈ 0.083
.setOrigin(0.5, 1)              // anchor bottom-center

// Give it a static physics body
platforms = this.physics.add.staticGroup();
platforms.add(this.add.rectangle(400, 568, 800, 64));  // invisible collider
